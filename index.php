...
<html lang="en">
<head>
  <title>WELCOME - HOTEL GANESHA</title>
  <meta charset="utf-8">
...
<div class="p-2 bg-dark text-white text-center">
  <h1>HOTEL GANESHA</h1>
  <p>Selamat datang di Hotel Ganesha Jakarta Indonesia!</p> 
</div>
<!------------------AKHIR BAGIAN HEADER----------------- -->
...
<nav class="navbar navbar-expand-sm navbar-dark bg-info">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">GANESHA</a>
...
<div class="container mt-2" id="panel_fasilitas_kami">
    <h2 class="text-center" >FASILITAS KAMI</h2>
      <h5 class="text-center">Hotel Ganesha</h5>
  ...
  <div class="d-flex justify-content-center">
    <div class="row">
     <div class="col-sm-12 p-5">
      ...
      <p> <b>Hotel Ganesha</b> Hotel Ganesha terkenal dengan keramahan kelas dunia, desain hotel yang mengagumkan dan standar layanan yang tak tertandingi di daerah Jakarta, Hotel Ganesha adalah resort bintang lima yang pertama di Kota Jakarta, Indonesia. Hotel Ganesha merupakan hotel yang terletak di pusat kota Jakarta dengan jarak tempuh kurang lebih 30-45 menit dari Taman Impian Jaya Ancol. Hotel Ganesha merupakan hotel dengan bangunan yang tergolong masih baru dengan fasilitas yang tentunnya akan membuat nyaman anda selama menginap di Hotel Ganesha.
    </p>
   </div>
  </div>
