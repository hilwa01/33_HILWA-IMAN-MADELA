...
<div id="invoice">
    ...
    <div class="invoice overflow-auto">
        <div style="min-width: 600px">
            <header>
                <div class="row">
                    ...
                    <div class="col company-details">
                        ...
                        <div>Jakarta, AZ 85004, INA</div>
                        <div>(123) 456-789</div>
                        <div>ganeshahotel@gmail.com</div>
                    </div>
                </div>
            </header>
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <div class="address">Jakarta, TX 79273, Indonesia</div>
            ...
            <footer>
                Bukti pemesanan kamar Hotel Ganesha Jakarta - Indonesia.
            </footer>
        </div>
